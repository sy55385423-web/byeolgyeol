...
const RECIPES: Record<AbilitySet, Recipe[]> = {
  love: [
    { label: "사교성", potential: { 표현성: 0.3, 대인접근성: 0.25, 자기주도: 0.2, 관계확장: 0.15, 정서개방: 0.1 }, channel: ["표현성", "통로개방"] , capSens: 1 },
...
export const COMPOSITE_NORM: Record<AbilitySet, Norm> = {
  love: { mean: 27.3, sd: 5.6, deciles: [21, 22.4, 23.7, 25.2, 26.4, 27.9, 29.5, 31.9, 35.5] },
  career: { mean: 23.4, sd: 4.9, deciles: [17.4, 19.5, 20.3, 21.6, 22.9, 24.2, 25.7, 27.6, 30.2] },
  wealth: { mean: 26.4, sd: 5.8, deciles: [19.2, 21.2, 23.1, 24.3, 26, 27.9, 29.6, 31.6, 34.2] },
};
...
export const ABILITY_DECILES: Record<AbilitySet, number[][]> = {
  love: [[6, 9, 10, 13, 15, 17, 19, 22, 28], [3, 6, 8, 9, 11, 14, 17, 21, 28], [39, 44, 46, 49, 50, 53, 56, 59, 63], [16, 19, 21, 23, 25, 28, 31, 35, 41], [16, 18, 20, 22, 24, 26, 28, 30, 33]],
  career: [[12, 15, 18, 20, 22, 24, 28, 33, 38], [25, 28, 30, 32, 34, 37, 39, 42, 45], [10, 13, 14, 15, 17, 19, 20, 22, 28], [12, 15, 18, 21, 24, 27, 30, 33, 37], [12, 15, 17, 18, 21, 23, 25, 28, 33]],
  wealth: [[20, 23, 25, 27, 30, 32, 35, 39, 44], [10, 12, 14, 16, 18, 19, 22, 25, 30], [23, 26, 28, 31, 35, 38, 41, 45, 49], [11, 13, 15, 16, 18, 19, 22, 24, 28], [16, 19, 22, 24, 26, 29, 32, 35, 43]],
};
